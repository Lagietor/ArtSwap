...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\NFTItemController' => 'getNFTItemControllerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\NFTCollectionRepository' => ['privates', 'App\\Repository\\NFTCollectionRepository', 'getNFTCollectionRepositoryService', true],
            'App\\Repository\\NFTItemRepository' => ['privates', 'App\\Repository\\NFTItemRepository', 'getNFTItemRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\NFTCollectionRepository' => '?',
            'App\\Repository\\NFTItemRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\JwtCreatedSubscriber'] ?? ($this->privates['App\\EventSubscriber\\JwtCreatedSubscriber'] = new \App\EventSubscriber\JwtCreatedSubscriber(($this->services['kernel'] ?? $this->get('kernel', 1)))));
        }, 1 => 'onJWTCreated'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\JWTCreatedSubscriber'] ?? ($this->privates['App\\EventSubscriber\\JWTCreatedSubscriber'] = new \App\EventSubscriber\JWTCreatedSubscriber(($this->services['kernel'] ?? $this->get('kernel', 1)))));
        }, 1 => 'onJWTCreated'], 0);
    ...
    protected function getSerializerService()
    {
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($e), 1 => new \ApiPlatform\RamseyUuid\Serializer\UuidDenormalizer(), 2 => $h, 3 => $k, 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $m), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $m), 6 => $k, 7 => $h, 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($i, $b, $c, $n, NULL, $l, NULL, $m), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($i, $o, $l), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($l, true), 11 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 14 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($i, $b, $c, $o, $n, $p, $e, $m, $q, [], new RewindableGenerator(function () {
            ...
            return new \EmptyIterator();
        }, 0), $i, $d), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $m), 18 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($q, $m, $a, $r, NULL)), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 23 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 24 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($p, $n, $o, NULL), 'page', 'pagination', $i, $e), $i, $n, $j), 25 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 26 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($s, $o, $p), 27 => $s], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $f, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
